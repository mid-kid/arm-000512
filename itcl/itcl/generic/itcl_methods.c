 ...
 *
 *     RCS:  $Id: itcl_methods.c,v 1.2 1999/01/27 18:56:06 jingham Exp $
 * ========================================================================
...
extern int 		*__imp_tclTraceCompile;

#define tclTraceCompile (*__imp_tclTraceCompile)

extern int 		*__imp_tclTraceExec;

#define tclTraceExec (*__imp_tclTraceExec)

extern Tcl_ObjType	*__imp_tclByteCodeType;

#define tclByteCodeType (*__imp_tclByteCodeType)
