...
output_rule_data()
{
    ...
    fprintf(output_file, "static YYCONST short yylhs[] = {%42d,",
...
output_yydefred()
{
    ...
    fprintf(output_file, "static YYCONST short yydefred[] = {%39d,",
...
output_base()
{
    ...
    if (!rflag) outline += 2;
    fprintf(output_file, "\n};\nstatic YYCONST short yyrindex[] = {%39d,",
	    base[nstates]);
    ...
    if (!rflag) outline += 2;
    fprintf(output_file, "\n};\nstatic YYCONST short yygindex[] = {%39d,",
	    base[2*nstates]);
