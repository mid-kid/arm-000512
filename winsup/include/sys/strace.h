...
#ifdef NOSTRACE
#define strace_printf(fmt...) 0
#define strace_printf_wrap(fmt...) 0
#define strace_printf_wrap1(fmt...) 0
#define strace()	0
#define strace_wm(msg...) 0
#define small_printf(fmt...) 0
#define system_printf(fmt...) 0
#else
...
#define strace() (myself->strace_mask)
