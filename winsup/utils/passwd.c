...
#define TIMEQ_FOREVER         -1UL
#define ONE_DAY               86400UL
#define USER_PRIV_ADMIN		 2

#define LM20_PWLEN		14

#define UF_SCRIPT             0x00001
#define UF_ACCOUNTDISABLE     0x00002
#define UF_HOMEDIR_REQUIRED   0x00008
#define UF_LOCKOUT            0x00010
#define UF_PASSWD_NOTREQD     0x00020
#define UF_PASSWD_CANT_CHANGE 0x00040
...
DWORD STDCALL NetQueryDisplayInformation (LPWSTR, DWORD, DWORD, DWORD, DWORD, LPDWORD, PVOID *);
DWORD STDCALL NetUserModalsGet (LPWSTR, DWORD, LPBYTE *);
DWORD STDCALL NetUserModalsSet (LPWSTR, DWORD, LPBYTE, LPDWORD);
