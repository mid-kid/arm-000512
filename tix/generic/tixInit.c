...
/* CYGNUS_LOCAL: For Tcl8.0.3 and greater use tcl_findLibrary to find the
 * Path to the script library.  Note, I have not added Tcl 8.1 yet because
 * 8.1a1 & 2 don't have this feature yet...
 */
