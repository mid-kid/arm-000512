...
SEND-PR:
SEND-PR: The only categories supported are those specified in the
SEND-PR: documentation or in your Cygnus Support Contract.  Submissions
SEND-PR: for categories not supported will be taken as suggestions only.
__EOF__
