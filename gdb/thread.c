...
/* For now we wrest INT_TO_THREADREF and REMOTE_GET_THREADINFO
   from remote.c  There should really be a cleaner way of 
   getting at them.
*/
     ...
     int from_tty;
{
  ...
  int                counter;
  struct gdb_ext_thread_info info;
  int set = TAG_THREADID | TAG_EXISTS | TAG_THREADNAME
