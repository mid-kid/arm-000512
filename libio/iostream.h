...
extern _IO_istream_withassign _G_DLLEXTERN cin;
// clog->rdbuf() == cerr->rdbuf()
extern _IO_ostream_withassign _G_DLLEXTERN cout;
extern _IO_ostream_withassign _G_DLLEXTERN cerr;

extern _IO_ostream_withassign _G_DLLEXTERN clog
#if _G_CLOG_CONFLICT
__asm__ ("__IO_clog")
#endif
;
