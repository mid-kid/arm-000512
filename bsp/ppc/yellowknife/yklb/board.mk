...
BOARD_EXTRA_OBJS    = $(BOARD_NAME)-rst-big.o init_$(BOARD_GENERIC_NAME)-big.o
...
BOARD_ROM_STARTUP   = $(BOARD_NAME)-start-big.o $(BOARD_NAME)-start.o $(BOARD_NAME)-c_start.o $(BOARD_NAME)-rst.o
