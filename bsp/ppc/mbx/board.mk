...
BOARD_HEADERS	    = 
BOARD_LIBBSP	    = lib$(BOARD_NAME)bsp.a
BOARD_OBJS	    = init_$(BOARD_NAME).o $(BOARD_NAME).o cache8xx.o
...
BOARD_ROM_STARTUP   = $(BOARD_NAME)-start.o $(BOARD_NAME)-c_start.o $(BOARD_NAME)-rst.o
