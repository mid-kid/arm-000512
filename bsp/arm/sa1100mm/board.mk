#
# sa1100mm/board.mk -- Makefile fragment for the
...
BOARD_HEADERS	    = bsp/$(BOARD_NAME).h bsp/sa-1100.h
BOARD_LIBBSP	    = lib$(BOARD_NAME).a
BOARD_OBJS	    = init_$(BOARD_NAME).o $(BOARD_NAME).o sa-1100.o
BOARD_CFLAGS	    = 
BOARD_LDFLAGS	    = -L../../newlib/
BOARD_DEFINES	    = -DBOARD_RESET_IMPLEMENTED
