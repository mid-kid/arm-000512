/*
 * ebsa-285.c -- Support for Intel(R) EBSA-285 Evaluation Board
 *
...
void flash_led(int n, int which)
{
    ...
    switch (which)
    {
    case 0: led = EBSA_285_SOFT_IO_RED_LED;   break;
    case 1: led = EBSA_285_SOFT_IO_GREEN_LED; break;
    case 2: led = EBSA_285_SOFT_IO_AMBER_LED; break;
    default: return;
    }
...
_bsp_board_init(void)
{
     ...
     */
    _bsp_platform_info.board = "Intel(R) EBSA-285 Evaluation Board";
