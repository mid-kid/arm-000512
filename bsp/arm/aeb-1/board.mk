#
# aeb-1/board.mk -- Makefile fragment for the ARM(R) AEB-1 Evaluation Board
#
...
BOARD_HEADERS	    = bsp/$(BOARD_NAME).h bsp/lh77790a.h
BOARD_LIBBSP	    = lib$(BOARD_NAME).a
BOARD_OBJS	    = init_$(BOARD_NAME).o $(BOARD_NAME).o lh77790a.o
BOARD_CFLAGS	    = -mcpu=arm7di -msoft-float
