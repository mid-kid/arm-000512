...
#define	GLOB_PERIOD	(1 << 7)/* Leading `.' can be matched by metachars.  */
  ...
  /* CYGNUS LOCAL: Define these unconditionally.  Otherwise, they will
     not get defined on OSF/1 4.0, which defines _POSIX_C_SOURCE but
     does not define _BSD_SOURCE.
