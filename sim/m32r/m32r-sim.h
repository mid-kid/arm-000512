...
#define GET_H_ACCUMS(regno) m32rxf_h_accums_get_handler (current_cpu, (regno))
#define SET_H_ACCUMS(regno, val) m32rxf_h_accums_set_handler (current_cpu, (regno), (val))

/* Misc. profile data.  */
