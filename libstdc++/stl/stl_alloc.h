...
# ifdef __DECLARE_GLOBALS_HERE
    void _G_DLLEXTERN (* __malloc_alloc_oom_handler)() = 0;
    // g++ 2.7.2 does not handle static template data members.
# else
    extern void _G_DLLEXTERN (* __malloc_alloc_oom_handler)();
# endif
#endif
...
# endif
  ...
  static char* _G_DLLEXTERN _S_start_free;
  static char* _G_DLLEXTERN _S_end_free;
  static size_t _G_DLLEXTERN _S_heap_size;
