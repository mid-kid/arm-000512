...
char *bison_library = NULL;		/* for -L */
char *simple_parser = NULL;		/* for -S */
char *hairy_parser = NULL;		/* for -H */
     ...
     char *argv[];
{
  ...
  while ((c = getopt_long (argc, argv, "yvdhrltknVo:b:p:L:S:H:", longopts, (int *)0))
	 != EOF)
    {
      switch (c)
	{
